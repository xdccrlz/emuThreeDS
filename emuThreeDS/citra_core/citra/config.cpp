...
Config::Config() {
    ...
    sdl2_config_loc = FileUtil::GetUserPath(FileUtil::UserPath::ConfigDir) + "sdl2-config.txt";
...
//    }
    ...
    Settings::values.layout_option =
        static_cast<Settings::LayoutOption>(sdl2_config->GetInteger("Layout", "layout_option", static_cast<int>(Settings::LayoutOption::SideScreen)));
    ...
    for (const auto& service_module : Service::service_module_map) {
        ...
        Settings::values.lle_modules.emplace(service_module.name, Settings::values.use_hle);
    }
